...
contract RewardDistribution {
    ...
    /// @notice Admin who can remove participants
    address public immutable admin;

    /// @notice Maximum allowed participants
    ...
    /// @notice Submit or update a device score. Enforces max cap.
    /// @param deviceId ID of the device being scored
    /// @param score Score between 1–100 (0 will be rejected here)
    function submitScore(string memory deviceId, uint256 score) external {
        ...
        // Add only if not yet a participant
    ...
    /// @notice Admin-only removal of a participant
